...
- [ ] **Backfill the ISPAD 2024 Clinical Practice Consensus Guidelines** — the ~25-chapter series in Horm Res Paediatr (late 2024) predates the dataset's coverage (store has zero Horm Res Paediatr 2024–2025 articles). One-off targeted PubMed fetch + merge; flagged by Christian 2026-08-04.
