...
- [ ] **Re-fetch metadata for the ~430 articles still lacking an abstract** — the paused job in `PedEndoLit Legacy Metadata Backfill Handoff.md`. The local-file merge got everything it could; the rest needs real PubMed calls.
