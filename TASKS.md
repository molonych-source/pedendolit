...
- [ ] **Pre-2024 guideline backfill** — guideline-only searches for 2018–2023 return: **32** hits in the 5 dedicated peds-endo journals (highest yield — the ISPAD 2018 and 2022 consensus series live there), 91 across all 19 monitored journals (extra ~59 skew adult; that search has no peds filter), 139 for the wide all-journals query at ~35% precision. **Recommended: run the 32 first** through the existing sweep → agent → approval-page flow. Rationale: society guidelines have long shelf lives, so a 2019 CAH guideline is still current practice.
